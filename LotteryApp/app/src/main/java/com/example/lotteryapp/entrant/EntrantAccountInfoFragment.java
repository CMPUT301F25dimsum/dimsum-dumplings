 ...
 * Purpose:
 * - Display the signed-in entrant's account details (email, name, phone) in read-only fields.
...
public class EntrantAccountInfoFragment extends Fragment {
     ...
     *
     * @param inflater LayoutInflater from host
    ...
    /**
     * Start MainActivity and clear the history so the user cannot navigate back here.
     */
